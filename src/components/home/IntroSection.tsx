      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            <div className="w-full md:w-2/5 flex justify-center md:justify-end order-1 md:order-none">
              <div className="relative w-64 h-64 md:w-80 md:h-80 drop-shadow-xl transition-transform duration-700 hover:scale-105">
                <Image 
                  src="/oatjar1.png" 
            ...
            {/* Content column */}
            <div className="w-full md:w-3/5 bg-[#f8f5ef] rounded-2xl p-8 md:p-10 border border-primary/10 shadow-sm">
              ...
              <h3 className="text-xl md:text-2xl text-accent/90 font-medium mb-6">
              ...
              <div className="space-y-3 mb-8">
                <div className="flex items-center">
                  ...
                  <p className="text-foreground/80">Ready in seconds — just grab and enjoy</p>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 rounded-full bg-accent mr-3"></div>
                  <p className="text-foreground/80">Premium ingredients for authentic flavour</p>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 rounded-full bg-accent mr-3"></div>
                  <p className="text-foreground/80">Locally sourced, sustainable packaging</p>
                </div>
              </div>
              
              {/* Email signup with discount offer */}
              <div className="bg-white rounded-lg p-5 border border-accent/20 shadow-sm">
                {!submitted ? (
                  <>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                      ...
                      <p className="text-xs text-foreground/60 text-center sm:text-left">
                        ...
                        <br />We&apos;ll notify you at launch with your exclusive discount code.
                      </p>
                    </form>
                  </>
                ) : (
